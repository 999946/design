...
var ResourceCard = function (_React$Component) {
    ...
    _createClass(ResourceCard, [{
        ...
        value: function render() {
            return React.createElement(react_native_1.View, {style: resource_card_style_1.default.container}, React.createElement(react_native_1.Image, {
                style : resource_card_style_1.default.image,
                source: this.props.pictureSource
            }), React.createElement(react_native_1.View, {style: resource_card_style_1.default.textContainer}, React.createElement(react_native_1.Text, {
                style        : resource_card_style_1.default.text,
                numberOfLines: 3
            }, this.props.title)));
        }
    }]);
