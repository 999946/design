...
var MarginPaddingEditor = function (_React$Component) {
    ...
    _createClass(MarginPaddingEditor, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", {
                className: "nt-web-margin-padding-editor-margin_padding_editor",
                style    : containerStyle
            }, React.createElement("div", {
                className: "left",
                style    : leftStyle
            }, this.renderTriangle('left', 'marginLeft'), this.renderTriangle('right', 'paddingLeft', {marginLeft: 5})), React.createElement("div", {
                className: "right",
                style    : rightStyle
            }, this.renderTriangle('left', 'paddingRight'), this.renderTriangle('right', 'marginRight', {marginLeft: 5})), React.createElement("div", {
                className: "top",
                style    : topStyle
            }, this.renderTriangle('top', 'marginTop'), this.renderTriangle('bottom', 'paddingTop', {marginTop: 5})), React.createElement("div", {
                className: "bottom",
                style    : bottomStyle
            }, this.renderTriangle('top', 'paddingBottom'), this.renderTriangle('bottom', 'marginBottom', {marginTop: 5})), React.createElement("div", {
                className: "number",
