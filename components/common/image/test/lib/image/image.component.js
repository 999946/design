...
let ImageComponent = class ImageComponent extends React.Component {
    ...
    render() {
        ...
        }, this.props.others), !(!this.state.loadImageSuccess && this.props.fallbackHideImage) &&
            React.createElement(react_native_1.Image, __assign({
                onError: this.handleLoadError.bind(this),
                onLoad : this.handleLoadSuccess.bind(this),
                source : this.state.source
            }, this.props.others)), !this.state.loadImageSuccess &&
