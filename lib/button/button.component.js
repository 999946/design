...
var Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            ...
            return React.createElement("button", __assign({ onClick: this.handleClick.bind(this), className: btnClass }, this.props.others), React.createElement("div", { className: "button-container" }, this.props.addonLeft ? addon : null, React.createElement("div", { className: "text-child" }, this.props.children), this.props.addonRight ? addon : null, this.props.loading ? loadingComponent : null));
        }
    }]);
