...
var Switch = function (_React$Component) {
    ...
    _createClass(Switch, [{
        ...
        value: function render() {
            ...
            var Switch = React.createElement("span", __assign({}, this.props.others, { className: switchClassName, onClick: this.props.disabled ? null : this.toggle.bind(this) }), React.createElement("span", { className: "inner" }, this.state.checked ? this.props.checkedChildrenRender : this.props.unCheckedChildrenRender));
            return Switch;
        }
    }]);
