...
var Collapse = function (_React$Component) {
    ...
    _createClass(Collapse, [{
        ...
        value: function render() {
            ...
            this.height = height;
            return React.createElement("div", __assign({}, this.props.others, { className: classes }), React.createElement("div", { className: "panel-heading", onClick: this.handleClick.bind(this) }, React.createElement("i", { className: rightChevronClass, style: { marginRight: 5 } }), this.props.header), React.createElement("div", { className: panelCollapseClass, style: contentContainerStyle }, React.createElement("div", { "data-fit-coll-content": true }, this.props.children)));
        }
    }]);
